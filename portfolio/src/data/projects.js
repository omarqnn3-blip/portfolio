...
export const projects = [
  ...
  },
  {
    ...
    insights: [
      ...
      'The real story is the spread: the bear case — AV disruption plus stalling margins — implies a drawdown of more than half, clustering the downside grid in the $24–$41 range.',
    ...
    process: [
      'Forecast 2026–2030 top-down: gross bookings, then revenue via the take rate, then adjusted EBITDA as a margin on bookings, walked down to unlevered free cash flow.',
